...
public class GameBoard extends JPanel
{
	...
	public static ImageIcon RASPBERRY = new ImageIcon("Images" + File.separator + "BerryBlast" + File.separator + "Rasberry.png");
	...
	//Pastel
	public static ImageIcon BLUEPASTEL = new ImageIcon("Images" + File.separator + "Pastel" + File.separator + "Blue.png");
	public static ImageIcon CYANPASTEL = new ImageIcon("Images" + File.separator + "Pastel" + File.separator + "Cyan.png");
	public static ImageIcon GREENPASTEL = new ImageIcon("Images" + File.separator + "Pastel" + File.separator + "Green.png");
	public static ImageIcon PINKPASTEL = new ImageIcon("Images" + File.separator + "Pastel" + File.separator + "Pink.png");
	public static ImageIcon ORANGEPASTEL = new ImageIcon("Images" + File.separator + "Pastel" + File.separator + "Orange.png");
	public static ImageIcon PURPLEPASTEL = new ImageIcon("Images" + File.separator + "Pastel" + File.separator + "Purple.png");
	public static ImageIcon REDPASTEL = new ImageIcon("Images" + File.separator + "Pastel" + File.separator + "Red.png");
	public static ImageIcon YELLOWPASTEL = new ImageIcon("Images" + File.separator + "Pastel" + File.separator + "Yellow.png");
